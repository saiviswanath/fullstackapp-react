export class ReviewModel {
    constructor(private _id: number, private _userEmail: string, private _date: string,
        private _rating: number, private _bookId: number, private _reviewDescription: string) {}
